...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Generate 5 creative blog title ideas for the keyword ${input} in the category ${selectedCategory}. Do not write any introduction or explanation. List each title on a new line.`
